...
### ✨ Особенности
* 📁 **Drag-and-drop:** Просто перетащите папку `audio` из игры прямо в окно программы. (не работает)
...
* 📁 **Drag-and-drop:** Drag your game's `audio` folder right into the application window. (not working)
